...
**Karyon** (KaryaOne) is a modern, high-performance Human Resource Information System (HRIS) designed to streamline organizational workflows. Built with the latest tech stack, it provides a seamless experience for both administrators and employees.
...
The Karyon HRIS is open-sourced software licensed under the [MIT license](LICENSE).
